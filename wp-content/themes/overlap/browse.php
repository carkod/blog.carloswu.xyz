<div id="alternative">
    <?php // Alternative Browsing menu  ?>
    
    <div id="alternative-menu" data-example-id="simple-nav-justified">

        <ul class="nav nav-tabs" role="tablist">
            
            <?php // Alternative browsing menu item list  ?>
    ...
    <?php // End Alternative Browsing menu  ?>
    
    <?php // Start Alternative Browsing content  ?>
...
<!-- End of alternative (browsing menu)-->